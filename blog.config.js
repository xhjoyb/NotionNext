...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '2eb5ea8e53e38177be94e8e07376880c,en:2ec5ea8e53e380d5b654f5b4a542cebf,photos:2ec5ea8e53e3808ab93bff6d11264d95,docs:2ec5ea8e53e380d1a429c8bcaddb0609',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '早清风', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '在世界边缘疯狂的尝试', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.joyb.cc', // 网站地址
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '赣ICP备2024048018号-1', // 备案号 闽ICP备XXXXXX
  BEI_AN_LINK: process.env.NEXT_PUBLIC_BEI_AN_LINK || 'https://beian.miit.gov.cn/', // 备案查询链接，如果用了萌备等备案请在这里填写
  BEI_AN_GONGAN: process.env.NEXT_PUBLIC_BEI_AN_GONGAN || '赣公网安备36102602000194号', // 公安备案号，例如 '浙公网安备3xxxxxxxx8号'
  ...
  // 自定义外部脚本，外部样式
  CUSTOM_EXTERNAL_JS: ['https://cdn.bootcdn.net/ajax/libs/jquery/3.7.1/jquery.min.js'], // e.g. ['http://xx.com/script.js','http://xx.com/script.js']
