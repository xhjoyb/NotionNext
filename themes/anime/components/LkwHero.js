...
const LkwHero = () => {
  ...
  const stats = [
    ...
    { value: '100%', label: '安全保障', desc: '账号安全承诺' }
  ]
  ...
  const highlights = [
    ...
    { icon: '🛡️', title: '安全托管', desc: '专业代肝不封号' },
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              ...
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 mb-6">
                ...
                <span className="text-sm text-white/80">专业代肝服务在线</span>
              </div>
            ...
            <div className={`transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 mb-6">
                <div className="text-center mb-4">
                  ...
                  <div className="text-white font-semibold">{stats[activeStat].label}</div>
                  <div className="text-white/60 text-sm">{stats[activeStat].desc}</div>
                </div>
                  ...
                  {stats.map((_, index) => (
                    <button
                      ...
                      className={`h-1.5 rounded-full transition-all duration-300 ${
                        index === activeStat ? 'w-8 bg-purple-400' : 'w-2 bg-white/30'
                      }`}
                    />
                  ))}
                </div>
